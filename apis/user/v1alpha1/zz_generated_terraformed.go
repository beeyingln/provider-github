...
func (tr *GpgKey) GetObservation() (map[string]interface{}, error) {
...
func (tr *GpgKey) SetObservation(obs map[string]interface{}) error {
...
func (tr *GpgKey) GetParameters() (map[string]interface{}, error) {
...
func (tr *GpgKey) SetParameters(params map[string]interface{}) error {
...
func (mg *InvitationAccepter) GetTerraformResourceType() string {
	return "github_user_invitation_accepter"
}
