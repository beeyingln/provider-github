...
func (tr *Label) GetObservation() (map[string]interface{}, error) {
...
func (tr *Label) SetObservation(obs map[string]interface{}) error {
...
func (tr *Label) GetParameters() (map[string]interface{}, error) {
...
func (tr *Label) SetParameters(params map[string]interface{}) error {
