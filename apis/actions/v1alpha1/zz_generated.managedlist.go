...
// GetItems of this OrganizationSecretList.
func (l *OrganizationSecretList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this OrganizationSecretRepositoriesList.
func (l *OrganizationSecretRepositoriesList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
