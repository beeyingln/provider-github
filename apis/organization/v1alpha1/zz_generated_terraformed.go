...
// GetTerraformResourceType returns Terraform resource type for this Block
func (mg *Block) GetTerraformResourceType() string {
	return "github_organization_block"
}

// GetConnectionDetailsMapping for this Block
func (tr *Block) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this Block
func (tr *Block) GetObservation() (map[string]interface{}, error) {
...
// SetObservation for this Block
func (tr *Block) SetObservation(obs map[string]interface{}) error {
...
// GetID returns ID of underlying Terraform resource of this Block
func (tr *Block) GetID() string {
...
// GetParameters of this Block
func (tr *Block) GetParameters() (map[string]interface{}, error) {
...
// SetParameters for this Block
func (tr *Block) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this Block using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Block) LateInitialize(attrs []byte) (bool, error) {
